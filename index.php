...
<html>
    ...
    <body>
        ...
        <script type="text/javascript" src="js/screens/coop.js"></script>
        <script type="text/javascript" src="js/screens/pickPlayer.js"></script>
        ...
        <script type="text/javascript" src="js/gamemanagers/ExpManager.js"></script>
        ...
        <script>
           //if click menu button change to menu
    $("#mainmenu").bind("click", function() {
                me.state.change(me.state.MENU);
            });
            //creates a user based on what they typed in
